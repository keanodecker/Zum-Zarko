...
export default function ReservationSection() {
  return (
    <section id="reservieren" className="py-32 bg-zarko-darker relative overflow-hidden">
            ...
            <div className="space-y-8 md:sticky md:top-32">
              <div>
                ...
                <h2 className="font-serif text-5xl md:text-6xl text-zarko-cream leading-none">
                  Wir freuen uns<br />
                  <span className="italic text-zarko-clay">auf Sie</span>
                </h2>
              </div>
              <p className="text-zarko-cream/60 leading-relaxed max-w-sm">
                Reservieren Sie Ihren Tisch direkt online. Bei größeren Gruppen
                (8+ Personen) oder der Peka-Spezialität bitten wir um telefonische Absprache.
              </p>
              <div className="space-y-3 text-sm">
                ...
                <a href="tel:07821983792" className="flex items-center gap-3 text-zarko-cream/70 hover:text-zarko-terra transition-colors">
                  <span className="w-1.5 h-1.5 rounded-full bg-zarko-terra flex-shrink-0" />
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Name *</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Telefon *</label>
                  <input type="tel" required placeholder="07821 …"
                    className="w-full bg-transparent border-b border-zarko-cream/20 py-3 text-zarko-cream placeholder-zarko-cream/30 focus:border-zarko-terra focus:outline-none transition-colors text-sm" />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">E-Mail</label>
                <input type="email" placeholder="ihre@email.de"
                  className="w-full bg-transparent border-b border-zarko-cream/20 py-3 text-zarko-cream placeholder-zarko-cream/30 focus:border-zarko-terra focus:outline-none transition-colors text-sm" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Datum *</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Uhrzeit *</label>
                  <select required className="w-full bg-zarko-darker border-b border-zarko-cream/20 py-3 text-zarko-cream/70 focus:border-zarko-terra focus:outline-none transition-colors text-sm">
              ...
              <div className="space-y-1.5">
                <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Personenanzahl *</label>
              ...
              <div className="space-y-1.5">
                <label className="text-xs tracking-widest text-zarko-cream/50 uppercase">Besondere Wünsche</label>
                <textarea rows={3} placeholder="Allergien, Sonderwünsche, Anlass …"
